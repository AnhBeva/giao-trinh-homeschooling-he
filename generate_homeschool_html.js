  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .hero-logo {
      ...
      border-radius: var(--radius);
      background: #fff;
      box-shadow: 0 14px 40px rgba(17, 106, 216, 0.10);
    }
    ...
    @media (max-width: 620px) {
      ...
      .hero-brand { align-items: flex-start; gap: 12px; }
      .hero-logo { width: 96px; height: 72px; }
      .hero-brand-copy { font-size: 13px; }
    ...
    <div class="content-wrap">
      <section class="hero" aria-labelledby="heroTitle">
        <div class="hero-brand">
          <img class="hero-logo" src="logo.jpg" alt="BEVA logo">
          <div class="hero-brand-copy"><strong>BEVA</strong>better mind, better life</div>
        </div>
